   ...
   // [Alias("Remove-AnfReplication")]
    public class RemoveAzureRmNetAppFilesReplication : AzureNetAppFilesCmdletBase
    {
        ...
        [Parameter(
            ...
            HelpMessage = "The pool object containing the ANF volume with the replication to remove")]
        [ValidateNotNullOrEmpty]
        ...
        [Parameter(
            ...
            Mandatory = true,
            ValueFromPipeline = true,
            HelpMessage = "The ANF volume with the replication to remove")]
        [ValidateNotNullOrEmpty]
