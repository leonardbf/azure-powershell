...
namespace Microsoft.Azure.Commands.NetAppFiles.Volume
{
    ...
    public class GetAzureRmNetAppFilesReplicationStatus : AzureNetAppFilesCmdletBase
    {
        ...
        [Parameter(
            ...
            HelpMessage = "The pool object containing the ANF volume with replication status to be returned")]
        [ValidateNotNullOrEmpty]
        ...
        public override void ExecuteCmdlet()
        {
            ...
            if (Name != null)
            { // TBD need the new SDK and to create the object being returned here
                //var anfReplicationStatuse = AzureNetAppFilesManagementClient.Volumes.RepliationStatusMethod(ResourceGroupName, AccountName, PoolName, Name);
