...
namespace Microsoft.Azure.Commands.NetAppFiles.Volume
{
   ...
   // [Alias("Reconnect-AnfReplication", "Resync-AnfReplication")]
    public class ResyncAzureRmNetAppFilesReplication : AzureNetAppFilesCmdletBase
    {
        ...
        [Parameter(
            ...
            HelpMessage = "The ANF pool object containing the volume to resync")]
        [ValidateNotNullOrEmpty]
        ...
        [Parameter(
            Mandatory = false,
            HelpMessage = "Return whether resync of the specified volume was performed")]
