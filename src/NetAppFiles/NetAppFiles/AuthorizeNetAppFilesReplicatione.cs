...
namespace Microsoft.Azure.Commands.NetAppFiles.Volume
{
    ...
    //[Alias("Authorize-AnfReplication", "Connect-AnfReplication")]
    public class AuthorizeAzureRmNetAppFilesReplication : AzureNetAppFilesCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            {// TBD we need the new SDK
                // AzureNetAppFilesManagementClient.Volumes.AuthorizeReplication(ResourceGroupName, AccountName, PoolName, Name, authorize object);
                success = true;
            }
